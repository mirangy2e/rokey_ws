...
class GoalPublisher(Node):
    ...
    #         while any(goal.status != GoalStatus.STATUS_CANCELED for goal in cancel_response.goals_canceling):
    #             time.sleep(0.1)  # Wait until all goals transition to STATUS_CANCELED

    #         self.get_logger().info('All goals successfully canceled. Exiting program...')
    #         self.destroy_node()
    #         rclpy.shutdown()
    #         sys.exit(0)  
    #     else:
