...
class GoalPoseLogger(Node):  # ROS2 노드 클래스
    def __init__(self):
        super().__init__('goal_pose_logger')  # 노드 이름 지정
        self.get_logger().info("GoalPoseLogger node is starting...")
